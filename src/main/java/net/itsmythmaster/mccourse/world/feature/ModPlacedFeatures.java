package net.itsmythmaster.mccourse.world.feature;
...
public class ModPlacedFeatures {
    ...
    public static final PlacedFeature COBALT_ORE_PLACED = PlacementUtils.register("cobalt_ore_placed",
            ModConfiguredFeature.COBALT_ORE.placed(ModOrePlacement.commonOrePlacement(MCCourseCommonConfigs.COBALT_ORE_VEINS_PER_CHUNK.get(), // VeinsPerChunk
