package net.itsmythmaster.mccourse.screen;

import net.itsmythmaster.mccourse.block.ModBlocks;
import net.itsmythmaster.mccourse.block.entity.CobaltBlasterBlockEntity;
import net.itsmythmaster.mccourse.screen.slot.ModFuelSlot;
import net.itsmythmaster.mccourse.screen.slot.ModResultSlot;
